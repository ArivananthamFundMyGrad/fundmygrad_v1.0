    ...
    <div className="w-full">
      <div className="bg-[#F1F4FA] w-full flex justify-center">
        <div className="w-full flex flex-col items-center">
          <div className="bg-white px-10 min-h-[64px] max-h-[64px] mobile:pl-[16px] mobile:pr-[16px] pt-3 pb-3 w-full flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <h1 className="ml-2 text-sm font-gola font-semibold">
                  Dashboard
                </h1>
              </div>
              <div
                ...
                className={`${
                  currentRoute.includes("/loanoffers")
                    ? "bg-[#DFECFF] pt-[11px] pb-[11px] pl-[16px] pr-[16px] rounded-lg"
                    : ""
                } flex items-center cursor-pointer ml-7`}
              >
                <svg
                  width="25"
                  height="24"
            ...
            <img
            style={{
              border: currentRoute.includes("/studentprofile") ? "2px solid #0057E4" : 0
            }}
            className="bg-[#F5F9FF] rounded-full p-[11px]" src="/ProfileIcon.svg" alt="Avatar" />
            </div>
          </div>
        </div>
      </div>
...
export default StudentPortalTopbar;
