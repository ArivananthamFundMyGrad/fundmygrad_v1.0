    ...
    >
      <div className="flex flex-col items-center mt-[40px]">
        ...
        >
          ...
          >
            <g opacity={`${currentRoute.includes("/telemarketing") ? "1" : "0.3"}`}>
              <path
                ...
                fill={`${
                  currentRoute.includes("/telemarketing") ? "#205ED7" : "#676767"
                }`}
              />
            </g>
          </svg>
      ...
      <div className="flex flex-col items-center mt-[36px]">
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g opacity={`${currentRoute.includes("/calltracking") || currentRoute.includes("/viewapplicationstatus") ? "1" : "0.3"}`}>
              <path
                d="M20 4H4C2.9 4 2 4.9 2 6V9H4V6H20V9H22V6C22 4.9 21.1 4 20 4Z"
                fill={`${
                  currentRoute.includes("/calltracking") || currentRoute.includes("/viewapplicationstatus") ? "#205ED7" : "#676767"
                }`}
              />
              <path
        ...
        <h1
          className={`${
            currentRoute.includes("/calltracking") || currentRoute.includes("/viewapplicationstatus") ? "font-semibold" : "font-normal"
          } mt-[5px] text-[11px] font-gola`}
        >
          Tracking
        </h1>
...
export default TelemarketingSidebar;
