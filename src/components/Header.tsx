...
function Header() {
  ...
  return (
    <div className="bg-light-color w-full flex flex-col items-center">
      <div style={{ zIndex: "9999" }} className="fixed bg-light-color w-full flex justify-center ">
        <div className="desktop:max-w-custom1300 w-full flex justify-between py-5">
